...
function scripts.ckn:cmdHelp()
    ...
    self:printCmdHelp("w[ycen]", "wycenia przedmioty u Javiera i wylicza prowizje")
    self:printCmdHelp("s[przedaz] start <operacja>", "rozpoczyna sprzedaz; jesli podana zostanie operacja, przy zapisie w logu zostanie ona onaczona")
    self:printCmdHelp("s[przedaz] stop", "konczy sprzedaz i wyswietla zarobek")
